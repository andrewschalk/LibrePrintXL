...
#define STRING_CONFIG_H_AUTHOR "Andrew Schalk" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LibrePrint XL"
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 24.73
  #define DEFAULT_bedKi 3.29
  #define DEFAULT_bedKd 123.96
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 45, 22, -.4 }
